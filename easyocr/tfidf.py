...
def extract_tfidf(bbox_rec_dir, bbox_ifidf_dir):
    text_ls = extract_txt_list(bbox_rec_dir)
    text_tfidf = train_tfidf_vectors(text_ls)
    export_bbox_ifidf(text_ls, text_tfidf)
